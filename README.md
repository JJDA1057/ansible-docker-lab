...
```
##Enjoy
You can also practice by yourself by changging some configuratios.

If you change any configuration you must re build the docker containers by running the commands below:
```bash 
docker compose down 
